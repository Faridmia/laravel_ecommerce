...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('pages', function (Blueprint $table) {
            $table->string('about_vision_title')->nullable()->after('description');
            ...
            $table->string('about_who_we_are_title')->nullable()->after('about_mission_description');
            $table->text('about_who_we_are_description')->nullable()->after('about_who_we_are_title');
        });
    }
