        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card shadow-sm mb-4">
                    ...
                    <form action="{{ route('admin.team.insert') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="designation" value="{{ old('designation') }}" class="form-control" placeholder="e.g. Founder & CEO" required>
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <small class="text-muted">Suggested size: 370x350px or square image.</small>
                            </div>

                            <div class="row mt-4">
                                <div class="col-md-4 mb-3">
                                    <label class="form-label fw-semibold text-secondary">Facebook URL</label>
                                    <input type="text" name="facebook_link" value="{{ old('facebook_link', '#') }}" class="form-control" placeholder="https://facebook.com/...">
                                </div>
                                <div class="col-md-4 mb-3">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" name="instagram_link" value="{{ old('instagram_link', '#') }}" class="form-control" placeholder="https://instagram.com/...">
                                </div>
                            </div>

                        </div>
                        <div class="card-footer bg-transparent py-3">
                            <button type="submit" class="btn btn-primary px-4 fw-semibold me-2">Save Member</button>
