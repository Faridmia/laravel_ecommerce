                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="subtitle" value="{{ old('subtitle', $slider->subtitle) }}" class="form-control" placeholder="e.g. Topsale Collection">
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="form-label fw-semibold text-secondary">Title (Main Heading)</label>
                                    <input type="text" name="title" value="{{ old('title', $slider->title) }}" class="form-control" placeholder="e.g. Living Room &lt;br&gt; Furniture (can use &lt;br&gt;)">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="button_link" value="{{ old('button_link', $slider->button_link) }}" class="form-control" placeholder="e.g. category/furniture or url('/')">
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <small class="text-muted d-block mb-2">Suggested image size: 1920x600 px. Leave empty to keep the current image.</small>
                                @if(!empty($slider->image))
                                    <div class="mt-2">
                                        <label class="form-label d-block fw-semibold text-secondary">Current Image:</label>
                                        <img src="{{ $slider->getImageUrl() }}" alt="current slider image" class="img-thumbnail" style="max-height: 150px;">
                                    </div>
                                @endif
                            </div>
