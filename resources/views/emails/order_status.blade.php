    ...
    <div class="email-wrapper">
        <div class="email-content">
            ...
            <div class="email-body">
                ...
                @php
                    $statusLabel = $order->status === 'completed' ? 'Delivered' : ($order->status === 'processing' ? 'Inprogress' : ucfirst($order->status));
                @endphp
                <p><strong>Order Status : {{ $statusLabel }}</strong></p>
                ...
                <div class="summary-details">
                    ...
                    <p><strong>Payment Method:</strong> {{ strtoupper($order->payment_method) === 'COD' ? 'Cash' : ucfirst($order->payment_method) }}</p>
                </div>
